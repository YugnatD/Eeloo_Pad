...
namespace PluginEelooPAD
{
    ...
    public class SettingsConfig : MonoBehaviour
    {
        ...
        private IPAddress ipAddr = ipHost.AddressList[0];
        private IPEndPoint localEndPoint;
        public static Vessel ActiveVessel = new Vessel();

        public DataToSend dataToSend; // Will contain 
        ...
        void Awake()
        {
            ...
            localEndPoint = new IPEndPoint("127.0.0.1", 11111);
    ...
    public class UpdateDataKSP : MonoBehaviour
    {
        ...
        void Update()
        {
            settingsConfig.dataToSend.AP = (float)ActiveVessel.orbit.ApA;
        }
}